...
#define TDM_SLAVE 			0		/* Can be 0 to 7 for TDM8 */
#define TDM_LRCLK_GEN		1		/* Enables Clock to generate TDM Clock */
#define DATASWITCH			1		/* 0 Microphone Data
...
#define TC_WAVEFORM_DUTY_CYCLE	2	/* duty cycle of 5% adept when better known*/
